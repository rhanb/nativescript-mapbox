...
declare class MGLAccountManager extends NSObject {
	...
	static readonly hasChinaBaseURL: boolean;
}
...
declare class MGLMapView extends UIView {
	...
	mapViewDidFinishRenderingFrameFullyRendered(fullyRendered: boolean): void;
...
declare class MGLStyle extends NSObject {
	...
	static navigationGuidanceDayStyleURLWithVersion(version: number): NSURL;

	static navigationGuidanceNightStyleURLWithVersion(version: number): NSURL;

	static navigationPreviewDayStyleURLWithVersion(version: number): NSURL;

	static navigationPreviewNightStyleURLWithVersion(version: number): NSURL;
	...
	static readonly navigationGuidanceDayStyleURL: NSURL;

	static readonly navigationGuidanceNightStyleURL: NSURL;

	static readonly navigationPreviewDayStyleURL: NSURL;

	static readonly navigationPreviewNightStyleURL: NSURL;
